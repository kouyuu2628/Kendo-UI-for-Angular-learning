...
@Component({
  selector: 'app-data-binding-derective',
  templateUrl: './data-binding-derective.component.html',
  styleUrls: ['./data-binding-derective.component.scss']
})
export class DataBindingDerectiveComponent implements OnInit {

  gridData: any[] = sampleCustomers;
